            ...
            Rectangle {
                ...
                Rectangle{
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"fullName")
                        font.pixelSize: 28
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"dobA")
                        font.pixelSize: 28
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"dobB")
                        font.pixelSize: 28
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"gender")
                        ...
                        ComboBox {
                            ...
                            onCurrentIndexChanged:  {
                                if (currentIndex >= 0 && currentIndex < combomodel1.count) {
                                    genderfield.text = combomodel1.get(currentIndex).text;
                                }
                            }
                        }
                    }
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"marital_status")
                        font.pixelSize: 28
                        ...
                        ComboBox {
                            ...
                            model: ListModel{
                                id:combomodel2
                                ListElement{text: "Select"}
                                ListElement{text: "Unmarried"}
                                ListElement{text: "Married"}
                                ListElement{text: "Others"}
                            }
                            Layout.fillWidth: true
                            onCurrentIndexChanged:  {
                                if (currentIndex >= 0 && currentIndex < combomodel2.count) {
                                    maritalstatusfield.text = combomodel2.get(currentIndex).text;
                                }
                            }
                        }
                ...
                Rectangle {
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"address")
                        font.pixelSize: 28
                    ...
                    TextField {
                        ...
                        text: mydb.retrieveUser(label1.text,"phone_number")
                ...
                Rectangle {
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"board_name")
                        font.pixelSize: 28
                    ...
                    TextField {
                        ...
                        y: 230
                        width: 750
                        text: mydb.retrieveUser(label1.text,"education_level")
                        height: 55
                        font.pixelSize: 28
                        background: Rectangle {
                            color: "white"
                        ...
                        ComboBox {
                            ...
                            model: ListModel{
                                ...
                                ListElement{text: "+2/Diploma"}
                                ListElement{text: "Bachelors"}
                                ListElement{text: "Masters"}
                                ListElement{text: "Mphill"}
                                ListElement{text: "PhD"}
                            }
                            Layout.fillWidth: true
                            onCurrentIndexChanged:  {
                                if (currentIndex >= 0 && currentIndex < combomodel3.count) {
                                    levelfield.text = combomodel3.get(currentIndex).text;
                                }
                            }
                        }
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"gpa_or_percentage")
                        font.pixelSize: 28
                        background: Rectangle {
                            color: "white"
                        }
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"faculty")
                        font.pixelSize: 28
                        background: Rectangle {
                            color: "white"
                        }
                        ComboBox {
                            ...
                            model: ListModel{
                                id:combomodel4
                                ListElement{text: "Select"}
                                ListElement{text: "Science"}
                                ListElement{text: "Management"}
                                ListElement{text: "Engineering"}
                                ListElement{text: "Arts"}
                                ListElement{text: "Law"}
                                ListElement{text: "Education"}
                                ListElement{text: "Medicine/ Healthcare"}

                            }
                            Layout.fillWidth: true
                            onCurrentIndexChanged:  {
                                if (currentIndex >= 0 && currentIndex < combomodel4.count) {
                                    facultyfield.text = combomodel4.get(currentIndex).text;
                                }
                            }
                        }
                ...
                Rectangle{
                    ...
                    TextField {
                        ...
                        text: mydb.retrieveUser(label1.text,"company_name")
                    ...
                    TextField {
                        ...
                        text: mydb.retrieveUser(label1.text,"company_address")
                        onTextChanged: {
                            // Change text color to black when the text changes
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"post")
                        font.pixelSize: 28
                        background: Rectangle {
                            color: "white"
                        }
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"working_field")
                        font.pixelSize: 28
                        background: Rectangle {
                            color: "white"
                        }
                    ...
                    TextField {
                        ...
                        height: 55
                        font.pixelSize: 28
                        text: mydb.retrieveUser(label1.text,"experience_years")
                        background: Rectangle {
                            color: "white"
                        }
                    ...
                    TextField {
                        ...
                        height: 55
                        font.pixelSize: 28
                        text: mydb.retrieveUser(label1.text,"experience_letter")
                        background: Rectangle {
                            color: "white"
                        }
                ...
                Rectangle{
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"photo_link")
                        font.pixelSize: 28
                        background: Rectangle {
                            color: "white"
                        }
                    ...
                    TextField {
                        ...
                        width: 750
                        height: 55
                        text: mydb.retrieveUser(label1.text,"signature_link")
                        font.pixelSize: 28
                        background: Rectangle {
                            color: "white"
                        }
                    ...
                    TextField {
                        ...
                        height: 55
                        font.pixelSize: 28
                        text: mydb.retrieveUser(label1.text,"citizenshipf_link")
                        background: Rectangle {
                            color: "white"
                        }
                    ...
                    TextField {
                        ...
                        height: 55
                        font.pixelSize: 28
                        text: mydb.retrieveUser(label1.text,"citizenshipb_link")
                        background: Rectangle {
                            color: "white"
                        }
                    ...
                    TextField {
                        ...
                        height: 55
                        font.pixelSize: 28
                        text: mydb.retrieveUser(label1.text,"resume_link")
                        background: Rectangle {
                            color: "white"
                        }
